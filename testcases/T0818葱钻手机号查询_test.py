...
# FROM: har/0818葱钻手机号查询.har

from httprunner import HttpRunner, Config, Step, RunRequest, RunTestCase


class TestCaseT0818葱钻手机号查询(HttpRunner):
    ...
    teststeps = [
        Step(
            ...
            .get(
                "https://api-primary.yangcong345.com/primary_account/shadow/userCourse"
            )
...
if __name__ == "__main__":
    TestCaseT0818葱钻手机号查询().test_start()
