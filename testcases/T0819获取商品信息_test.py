...
# FROM: har/0819获取商品信息.har

from httprunner import HttpRunner, Config, Step, RunRequest, RunTestCase


class TestCaseT0819获取商品信息(HttpRunner):
    config = Config("testcase description").verify(False)

    teststeps = [
        Step(
            RunRequest("/primary_account/commodity/getCommodityList")
            .post(
                "https://api-primary.yangcong345.com/primary_account/commodity/getCommodityList"
            )
            .with_headers(
                **{
                    "content-length": "74",
            ...
            .with_json(
                {
                    "platform": "unknown",
                    "filter": {"commodityId": "5f34e498af3158758f3d229a"},
                }
            )
            .validate()
...
if __name__ == "__main__":
    TestCaseT0819获取商品信息().test_start()
