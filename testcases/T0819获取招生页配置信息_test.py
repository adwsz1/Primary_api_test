...
# FROM: har/0819获取招生页配置信息.har

from httprunner import HttpRunner, Config, Step, RunRequest, RunTestCase


class TestCaseT0819获取招生页配置信息(HttpRunner):
    config = Config("testcase description").verify(False)

    teststeps = [
        Step(
            RunRequest("/primary_enrollment/api/enrollmentPage/getEnrollmentPageInfo")
            .get(
                "https://api-primary.yangcong345.com/primary_enrollment/api/enrollmentPage/getEnrollmentPageInfo"
            )
            .with_params(**{"planPageId": "46"})
            .with_headers(
                **{
                    ...
                    "if-none-match": 'W/"869-NaCoXYgLPgPQkOLccOmrGno2Byk"',
                }
            )
            .validate()
...
if __name__ == "__main__":
    TestCaseT0819获取招生页配置信息().test_start()
