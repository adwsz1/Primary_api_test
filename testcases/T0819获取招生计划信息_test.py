...
# FROM: har/0819获取招生计划信息.har

from httprunner import HttpRunner, Config, Step, RunRequest, RunTestCase


class TestCaseT0819获取招生计划信息(HttpRunner):
    ...
    teststeps = [
        Step(
            ...
            .get(
                "https://api-primary.yangcong345.com/primary_enrollment/api/enrollmentPlan/getEnrollmentPlanInfo"
            )
            ...
            .with_headers(
                **{
                    ...
                    "if-none-match": 'W/"2c1-zcy8cATMXhLav51C7aMQ9Fp3qUI"',
                }
            )
            .validate()
...
if __name__ == "__main__":
    TestCaseT0819获取招生计划信息().test_start()
