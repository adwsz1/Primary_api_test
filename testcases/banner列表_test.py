...
# FROM: har/banner列表.har


from httprunner import HttpRunner, Config, Step, RunRequest, RunTestCase


class TestCaseBanner列表(HttpRunner):

    config = Config("testcase description").verify(False)

    teststeps = [
        Step(
            RunRequest("/primary_account/banner/list")
            .get("https://api-wx.yangcong345.com/primary_account/banner/list")
            .with_headers(
                **{
