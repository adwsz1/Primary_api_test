...
# FROM: har/0818葱钻订单手机号搜索.har

from httprunner import HttpRunner, Config, Step, RunRequest, RunTestCase


class TestCaseT0818葱钻订单手机号搜索(HttpRunner):
    ...
    teststeps = [
        Step(
            ...
            .get(
                "https://api-primary.yangcong345.com/primary_account/shadow/coin-order/orders"
            )
            ...
            .with_headers(
                **{
                    ...
                    "referer": "https://yangcong345.com/admin/dimand/order",
...
if __name__ == "__main__":
    TestCaseT0818葱钻订单手机号搜索().test_start()
