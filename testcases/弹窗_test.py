...
class TestCase弹窗(HttpRunner):
    config = Config("testcase description").verify(False)

    teststeps = [
        Step(
            RunRequest("/primary_account/banner/popupV2")
            .get("https://api-wx.yangcong345.com/primary_account/banner/popupV2")
            .with_params(**{"userId": "5ebb670226002e00017e470d", "scene": "1"})
            .with_headers(
                **{
