...
# FROM: har/0819获取用户的优惠券信息.har

from httprunner import HttpRunner, Config, Step, RunRequest, RunTestCase


class TestCaseT0819获取用户的优惠券信息(HttpRunner):
    config = Config("testcase description").verify(False)

    teststeps = [
        Step(
            RunRequest("/primary_account/coupon/user/coupon/getUserCouponsList")
            .get(
                "https://api-primary.yangcong345.com/primary_account/coupon/user/coupon/getUserCouponsList"
            )
            .with_params(**{"userId": "5dc286501e86f00f5f49fb67"})
            .with_headers(
                **{
...
if __name__ == "__main__":
    TestCaseT0819获取用户的优惠券信息().test_start()
